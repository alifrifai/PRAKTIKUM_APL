...
void tambahkan_anime(string anime[], string genre[], float rating[], int episode[], int& dataAnime) {    
    ...
    if (dataAnime < MAX_ANIME) {
        ...
        string tambah;
        cout << "\nApakah anda ingin menambahkan anime lagi y/n? ";
        cin >> tambah;
        if (tambah == "y") {
            tambahkan_anime(anime, genre, rating, episode, dataAnime);
        } else if (tambah == "n") {
            cout << "Terima kasih telah menambah data animenya...\n";
        } else {
...
void hapus_dataAnime(string anime[], string genre[], float rating[], int episode[], int& dataAnime) {        // PROSEDUR BANG
    system("cls");
    tampilkan_dataAnime(anime, genre, rating, episode, dataAnime);
